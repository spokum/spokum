const paths = {
  ...
  maple: '<path d="M12 3.2l2 3.6 1.6-.6-.5 2.2 3.4 1-2.1 1.6 3.1 2.1-3.6.7.5 2.3-3.2-1.1-1.2 2.7-1.2-2.7-3.2 1.1.5-2.3-3.6-.7 3.1-2.1-2.1-1.6 3.4-1-.5-2.2 1.6.6z"/><path d="M12 15.6V21"/>',
